...
const Banner = () => {
    return (
        <>
            <div className="banner-all-content flex justify-center items-center flex-col py-3">
                ...
                <div className="banner-search mt-6 max-w-md  w-full relative">
                    ...
                    <div className="search-btn absolute right-0 top-0">
                        <button className='bg-rose-600 w-24 h-11 text-white rounded-3xl'>Search</button>
                    </div>
                </div>
            </div>
        </>
